		...
		<div class="container">
			...
			<div class="w-panel-sides large-sides list-news">
				<div class="w-large list-news-items">
					<div class="news-items flex jcsb">
						<div class="news-item on">
			            	<a href="#"></a>
					...
					<div class="news-items blocks flex jcsb">
						<div class="news-item blocks__block" id="1"></div>
						<div class="news-item blocks__block" id="2"></div>
						<div class="news-item blocks__block" id="3"></div>
						<div class="news-item blocks__block" id="4"></div>
						<div class="news-item blocks__block" id="5"></div>
					...
					<aside class="aside-panel">
						<div class="filter">
							...
							<ul class="filter-list">
								...
								<li><label><input type="checkbox"><i></i><span>2017</span></label></li>
							</ul>
						</div>
					</aside>
					<aside>
